...
[_QWERTY] = LAYOUT(
    ...
    TT(_LOWER), KC_LALT, KC_LGUI, KC_LCTL, KC_ENT, KC_SPC, KC_RALT, KC_APP, KC_RCTL, TT(_RAISE)
),
 ...
 */
[_ADJUST] = LAYOUT(
    KC_NO, KC_NO, TO(1), TO(2), TO(3), TO(4), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_INS, KC_NO, KC_PSCR, KC_NO, KC_NO, RM_TOGG, RM_HUEU, RM_SATU, RM_VALU, KC_NO, KC_NO, KC_PAUS, KC_SCRL, KC_CAPS, KC_NO, KC_NO, KC_NO, RM_NEXT, RM_HUED, RM_SATD, RM_VALD, KC_NO, KC_TRNS, KC_TRNS, KC_NUM, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
